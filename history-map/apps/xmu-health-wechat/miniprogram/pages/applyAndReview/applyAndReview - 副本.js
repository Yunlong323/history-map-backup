...
Page({
  ...
  */
  onReachBottom: function () {
     var that = this;
    if(that.currentTab==1){
      console.log("触底"+this.selectComponent("#check"));
      this.selectComponent("#check").getMyApprove();
      // this.getMyApprove();
    }
    if(that.data.currentTab==2){
      console.log("触底"+this.selectComponent("#submit"));
      // this.selectComponent("#submit").getMyApply();
      this.getMyApply();
      // this.getMyApprove();
    }
    if(that.data.currentTab==2){
      console.log("触底"+this.selectComponent("#myApply"));
      // this.selectComponent("#submit").getMyApply();
      this.getMyApply();
      // this.getMyApprove();
    }
