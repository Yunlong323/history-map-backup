document.addEventListener('DOMContentLoaded', function () {
    ...
    var id_t = write[0].querySelector('input');
    var name_t = write[1].querySelector('input');
    var xmu_t = write[2].querySelector('input');
    var cloud_t = write[3].querySelector('input');
    var score_t = write[4].querySelector('input');
    var open_time_t = write[5].querySelector('input');
    var must_know_t = write[6].querySelector('textarea');
    var intro_text_t = write[7].querySelector('textarea');
    var intro_audio_t = write[8].querySelector('input');
    var intro_video_t = write[9].querySelector('input');
    ...
    btn.addEventListener('click', function () {
        ...
        if (id_t.value && name_t.value && xmu_t.value && cloud_t.value && score_t.value && open_time_t.value && must_know_t.value && intro_text_t.value && intro_audio_t.value && intro_video_t.value && flag_last) {
            // console.log('66');
            ...
            axios({
                ...
                data: {
                    ...
                    intro_video: intro_video_t.value
                }
            }).then(response => {
