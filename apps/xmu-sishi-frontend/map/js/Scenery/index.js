document.addEventListener('DOMContentLoaded', function() {
    ...
    var intro_video_t = write[8].querySelector('input');
    ...
    btn.addEventListener('click', function() {
        ...
        if (name_t.value && xmu_t.value && cloud_t.value && score_t.value && open_time_t.value && must_know_t.value && intro_text_t.value && intro_audio_t.value && intro_video_t.value && flag_last) {
            axios({
                // method: 'GET',
                method: 'POST',
